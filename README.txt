...
click the submit button when done to add their changes to the database. Our php file takes the post value from the form and based on that, assigns the appropraite number of 
