...
<html>
  ...
  <body>
    ...
    <div class="calcbox">
      ...
      <form method="post" action="main.php" id="Courses_Insert">
      ...
      <h2>Insert Grades</h2>
      <form method="post" action="main.php" id="Grades_Insert">
      ...
      <form name="insertstudent" method="post" action="main.php">
        <label for="rin">RIN:</label><br>
